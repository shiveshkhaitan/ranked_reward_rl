...
class BPP(gym.Env):
    def __init__(self, env_config):
        ...
        self.observation_space = spaces.Dict(
            {
                'states': spaces.Box(-1, self.max_bin_size[0], shape=(self.num_items, 2 * self.dim + 1)),
                'actions': spaces.Box(-1, self.max_bin_size[0], shape=(self.num_items * self.max_bin_size[0], 2)),
            }
        )
